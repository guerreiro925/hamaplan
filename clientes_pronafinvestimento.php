          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h1 class="text-center">Clientes - Pronaf Investimento</h1>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<?php
$consulta = mysql_query("SELECT * FROM clientes WHERE deletar != '1' and tipo = 'pronaf_investimento'");
