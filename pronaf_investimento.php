...
<title>Pronaf Investimento</title>
...
function myFunction() {
    window.print();
	setTimeout("window.location='clientes_pronafinvestimento.php'", 1);
}
</script>
</head>
...
<!----------------------------------- SEGUNDA FOLHA ------------------------------------->
    ...
    <table class="table font-tabela">
        ...
        <tr>
        	...
        	<td class="text-center">Atenciosamente,<br /><br /></td>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	<table class="table font-tabela">
		...
		<tr>
    		...
    		<td class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;Na condição de primeiro usuário, declaro  o  recebimento, nesta data,  do ................................., nr chassi/série ...............................  ,  discriminados  na(s)  nota(s) fiscal(is) n.º ..............     , conforme  especificação  do(s)  orçamento(s),  estando  os bens novos e em condições para o seu perfeito funcionamento, e desde já autorizo o pagamento dos produtos diretamente na conta de depósitos do fornecedor. </td>
        
        </tr>
		
		<tr>
        
        	<td class="text-center"><?php echo $linha['cidade'];?>-<?php echo $linha['estado'];?>, <?php echo strftime($dataExtenso);?><br /><br /></td>
        
        </tr>
		
		<tr>
        
        	<td class="text-center">_______________________________<br /><br /></td>
	...
	<table class="table font-tabela">
		...
		<tr>
			...
			<td class="text-left">Agência: <?php echo $linha['numero'];?>  <?php echo $linha['cidade'];?> - <?php echo $linha['estado'];?></td>
