...
$(document).ready(function(){             $("#getEndereco").click(function(){                 getEndereco($("#cep").val());             });           }); 
  ...
  <body class="nav-md">
	...
	<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM clientes WHERE idCliente = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>

                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_clientes" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nome" id="nome" value="<?php echo $dados['nome'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha o nome do cliente.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="cpf" id="cpf" value="<?php echo $dados['cpf'];?>" required data-inputmask="'mask' : '999.999.999-99'" placeholder="Preencha um CPF válido.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                          ...
                          <div class="col-xs-12 col-md-6 col-sm-6">
						   <input type="text" name="cep" value="<?php echo $dados['cep'];?>" id="cep"required data-inputmask="'mask' : '99999-999'" placeholder="Preencha um CEP válido.." required class="form-control col-md-7 col-xs-12">
						  </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="cidade" readonly required id="cidade" value="<?php echo $dados['cidade'];?>" placeholder="Preencha a cidade.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="estado" readonly id="estado" required value="<?php echo $dados['estado'];?>" placeholder="Preencha um Estado.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="endereco" id="endereco" required value="<?php echo $dados['endereco'];?>" placeholder="Preencha endereço da agência e o nº.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="agencia" id="agencia" required value="<?php echo $dados['agencia'];?>" placeholder="Preencha uma agência.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="numero" id="numero" required data-inputmask="'mask' : '9999-9'" value="<?php echo $dados['numero'];?>" placeholder="Preencha um número da agência.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button id="send" type="submit"  class="btn btn-info">Salve</button>
                        </div>
                      </div>
