            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <a href="usuarios_incluir.php" style="color: #fff">
...
while ($dados = mysql_fetch_array($consulta))
{
	...
	?>	
                        <tr>
                            ...
                            <td>Edite para ver a senha</td>
                            <td class="contod"><?php echo $dados['email']; ?></td>
                            <td><a href="usuarios_editar.php?id=<?php echo $dados['idUsuario'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_usuarios&id=<?php echo $dados['idUsuario'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
