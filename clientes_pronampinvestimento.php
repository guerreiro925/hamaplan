          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h1 class="text-center">Clientes - Pronamp Investimento</h1>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <p class="btn btn-dark">
                        <a href="clientes_incluir.php" style="color: #fff"><i class="fa fa-plus-circle"></i>&nbsp;Adicionar cliente</a>
                  </p>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
							...
							<th>Agência</th>
							<th>Nº da Agência</th>
							<th class="contoth">Tipo</th>
							<th>Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM clientes WHERE deletar != '1' and tipo = 'pronamp_investimento'");
while ($dados = mysql_fetch_array($consulta))
{
	...
	?>	
                        <tr>
                            ...
                            <td><a href="clientes_editar.php?id=<?php echo $dados['idCliente'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_clientes&id=<?php echo $dados['idCliente'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></a></i><a href="pronamp_investimento.php?id=<?php echo $dados['idCliente'];?>"><i class="fa fa-file"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
                  </div>
