              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=add_usuarios" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="usuario" id="usuario" class="form-control col-md-7 col-xs-12"placeholder="Preencha um usuário.." required type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="senha" id="senha" data-validate-length="6,7" placeholder="Preencha uma senha.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="email" id="email" placeholder="Preencha um email.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
